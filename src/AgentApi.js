...
class AgentApi {
    ...
    */
    ...
    requestCrmQueueMonitorInfo() {
        const data = { "messageId": 3203, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID };
        this.connection.send(data);
    }
    ...
    requestStartQueueMonitoring(queueCodes) {
        const data = { "messageId": 268, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID, "queues": queueCodes };
        this.connection.send(data);
    }
    ...
    requestStopQueueMonitoring() {
        const data = { "messageId": 269, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID };
        this.connection.send(data);
    }
    ...
    playVoice(path) {
        ...
        const data = { "messageId": 301, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID, "uuid": line.callId, "filePath": path };
        this.connection.send(data);
    }
    ...
    playText(text) {
        ...
        const data = { "messageId": 301, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID, "uuid": line.callId, "type": 1, "text": text };
        this.connection.send(data);
    }
    ...
    stopPlay() {
        ...
        const data = { "messageId": 303, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID, "uuid": line.callId };
        this.connection.send(data);
    }
    ...
    pausePlay() {
        ...
        const data = { "messageId": 304, "thisDN": this.agent.thisDN, "agentID": this.agent.agentID, "uuid": line.callId };
        this.connection.send(data);
    }
